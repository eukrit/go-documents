                ...
                "images": [
                    {
                        ...
                        "caption": "Serge Ferrari — Soltis 502 Proof product page (source)",
                        "role": "primary",
                        "credit": "Serge Ferrari",
                    },
                    {
                        "url": "",
                        "caption": "Shade sail application (reference image — to be attached)",
                        "role": "gallery",
                        "credit": "",
                    },
                    {
                        "url": "",
                        "caption": "Pergola roof application (reference image — to be attached)",
                        "role": "gallery",
                        "credit": "",
                    },
                ],
                "colors": [
                    {"code": "502-50202", "name": "White",      "hex": "#F5F2E8", "finish": "satin",
                     "notes": "Reference swatch — verify against physical sample."},
                    {"code": "502-50264", "name": "Ivory",      "hex": "#E8DBC0", "finish": "satin",
                     "notes": "Reference swatch — verify against physical sample."},
                    {"code": "502-50166", "name": "Sand",       "hex": "#D4B896", "finish": "satin",
                     "notes": "Reference swatch — verify against physical sample."},
                    {"code": "502-50167", "name": "Grey",       "hex": "#888A8C", "finish": "satin",
                     "notes": "Reference swatch — verify against physical sample."},
                    {"code": "502-50258", "name": "Anthracite", "hex": "#3A3C40", "finish": "satin",
                     "notes": "Reference swatch — verify against physical sample."},
                    {"code": "502-50268", "name": "Black",      "hex": "#1A1A1A", "finish": "satin",
                     "notes": "Reference swatch — verify against physical sample."},
                    {"code": "502-50169", "name": "Taupe",      "hex": "#8A7868", "finish": "satin",
                     "notes": "Reference swatch — verify against physical sample."},
                    {"code": "502-50207", "name": "Brown",      "hex": "#6B4F3A", "finish": "satin",
                     "notes": "Reference swatch — verify against physical sample."},
                ],
