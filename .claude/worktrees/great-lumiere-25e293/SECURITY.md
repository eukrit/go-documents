...
### 3. GitHub
- [ ] Branch protection on `main`: applied via `apply-branch-protection.sh eukrit/go-documents`
...
- [ ] Remove GitHub collaborator: `gh api -X DELETE repos/eukrit/go-documents/collaborators/[username]`
